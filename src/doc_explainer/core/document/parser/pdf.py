...
class PDFParser(DocumentParser):
    ...
    def create_metadata(self, document: Document) -> Dict[str, Any]:
        """Create metadata for the document"""
        return self.metadata_creator.create_metadata(document)
    ...
    def _convert_to_document(self, raw_tree: Dict, file_path: str) -> Document:
        ...
        sections = [self._convert_section(child) for child in raw_tree["children"]]
    ...
    def _convert_section(self, raw_section: Dict) -> Section:
        ...
        subsections = [self._convert_section(child) for child in raw_section.get("children", [])]
