...
from ..steps.build_tree import build_tree_step
from ..steps.index import index_step
from ..steps.parse import parse_document_step


@pipeline
def doc_ingestion_pipeline(registry, file_path: str, target_query: str = None, force_reprocess: bool = False):
