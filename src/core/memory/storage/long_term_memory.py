...
class LongTermMemory(MemoryStorage, LongTermMemoryInterface):
    ...
    def retrieve_summarization(self, query: str) -> Optional[Dict]:
    ...
    def retrieve_explanation(self, query: str) -> Optional[Dict]:
    ...
    def retrieve_question_answer(self, query: str) -> Optional[Dict]:
