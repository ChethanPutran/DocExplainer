...
class AdaptiveExplainer(BaseExplanationEngine):
    ...
    def _get_resource_from_suggestion(self, suggestion: 'ResourceSuggestion') -> Optional[Resource]:
        ...
        try:
            ...
            difficulty = suggestion.difficulty.value if hasattr(suggestion.difficulty, 'value') else str(suggestion.difficulty)
    ...
    def enrich_specific_concept(self, concept: str, level: Optional[str] = None) -> List[Resource]:
        """
